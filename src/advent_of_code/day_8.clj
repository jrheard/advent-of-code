...
; literals, one on each line. The only escape sequences used
...
; i guess the first thing to do is convert \xa2 to a character
; then you can read the string after that
